...
#include "C_ActionProcess_NormalMonster.generated.h"

/**
 * 
 */
UCLASS()
class UE_PROJECT_API AC_ActionProcess_NormalMonster : public AC_ActionProcess
{
	GENERATED_BODY()

public:

	AC_ActionProcess_NormalMonster();
